...
const MapFill: FC<T.GenericIconsProps> = ({ size = 16 }) => {

  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" className="bi bi-map-fill" viewBox="0 0 16 16">
